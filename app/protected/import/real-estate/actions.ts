  ...
  try {
    ...
    if (newProperties.length > 0) {
      const payloads = newProperties.map((p) => ({
        ...
        transfer_tax_cents: p.row.transfer_tax_cents,
        notary_cents: p.row.notary_cents,
        registry_cents: p.row.registry_cents,
        agency_fee_cents: p.row.agency_fee_cents,
        renovation_cost_cents: p.row.renovation_cost_cents,
        other_purchase_costs_cents: p.row.other_purchase_costs_cents,
