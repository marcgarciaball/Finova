...
export const propertyRowSchema = z.object({
  ...
  transfer_tax_cents: centsSchema.nonnegative(),
  notary_cents: centsSchema.nonnegative(),
  registry_cents: centsSchema.nonnegative(),
  agency_fee_cents: centsSchema.nonnegative(),
  renovation_cost_cents: centsSchema.nonnegative(),
  other_purchase_costs_cents: centsSchema.nonnegative(),
...
export const createPropertySchema = z
  .object({
    ...
    transferTax: decimalString.default('0'),
    notary: decimalString.default('0'),
    registry: decimalString.default('0'),
    agencyFee: decimalString.default('0'),
    renovationCost: decimalString.default('0'),
    otherPurchaseCosts: decimalString.default('0'),
